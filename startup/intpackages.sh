...
sudo apt install -y  python3-vlc python3-pil python3-rpi.gpio python3-luma.lcd python3-mutagen bluez-alsa-utils bluez-tools pulseaudio-module-bluetooth python3-spidev
